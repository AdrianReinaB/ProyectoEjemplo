...
public class ProfesorAdapter extends RecyclerView.Adapter<ProfesorAdapter.ViewHolder> {
    ...
    private final VerDatos.OnListFragmentInteractionListener mListener;

    public ProfesorAdapter(List<Profesor> profesores, VerDatos.OnListFragmentInteractionListener listener) {
